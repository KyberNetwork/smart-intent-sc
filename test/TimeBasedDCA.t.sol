...
//   KSTimeBasedDCAIntentValidator dcaValidator;
...
//     IKSSmartIntentRouter.IntentData memory intentData = _getIntentData();
...
//       IKSSmartIntentRouter.ERC20Data({token: tokenIn, amount: amountIn, permitData: ''});
...
//         vm.expectRevert(
//           abi.encodeWithSelector(KSTimeBasedDCAIntentValidator.ExceedNumSwaps.selector, numSwaps, i)
//         );
//       }
...
//           KSTimeBasedDCAIntentValidator.InvalidExecutionTime.selector,
//           timestamps[i],
...
//     IKSSmartIntentRouter.IntentData memory intentData = _getIntentData();
//     KSTimeBasedDCAIntentValidator.DCAValidationData memory validationData = abi.decode(
//       intentData.coreData.validationData, (KSTimeBasedDCAIntentValidator.DCAValidationData)
//     );
...
//       vm.expectRevert(
//         abi.encodeWithSelector(
//           KSTimeBasedDCAIntentValidator.InvalidAmountOut.selector,
//           minAmountOut,
//           maxAmountOut,
//           actualAmountOut
//         )
