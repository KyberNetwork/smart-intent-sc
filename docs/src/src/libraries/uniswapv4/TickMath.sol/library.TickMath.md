# TickMath
[Git Source](https://github.com/KyberNetwork/smart-intent-sc/blob/93222d2e196228c709f4e585edadefb65277a3e4/src/libraries/uniswapv4/TickMath.sol)
...
|Name|Type|Description|
|----|----|-----------|
|`sqrtP`|`uint160`|A Fixed point Q64.96 number representing the sqrt of the ratio of the two assets (token1/token0) at the given tick|
...
*Throws in case sqrtP < MIN_SQRT_RATIO, as MIN_SQRT_RATIO is the lowest value getRatioAtTick may
ever return.*
...
|Name|Type|Description|
|----|----|-----------|
|`sqrtP`|`uint160`|The sqrt ratio for which to compute the tick as a Q64.96|
