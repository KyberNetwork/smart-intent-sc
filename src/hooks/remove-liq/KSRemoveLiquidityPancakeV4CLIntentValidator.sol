...
contract KSRemoveLiquidityPancakeV4CLIntentValidator is
  BaseIntentValidator,
  BaseConditionalValidator
{
  ...
  function _cacheAndDecodeValidationData(
    ...
    localVar.positionManager = ICLPositionManager(validationData.nftAddresses[index]);
    localVar.clPoolManager = localVar.positionManager.clPoolManager();
    ...
    localVar.poolId = _toId(poolKey);

    {
      (localVar.sqrtPriceX96, localVar.ticks[1],,) =
        localVar.clPoolManager.getSlot0(localVar.poolId);
