...
contract KSRemoveLiquidityUniswapV4Hook is BaseConditionalHook {
  ...
  function _cacheAndDecodeHookData(bytes calldata data, LocalVar memory localVar, uint256 index)
    internal
    view
